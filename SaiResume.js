...
/*{
  ...
  Education: [
    {
      'UG Degree': 'B.E in Telecommunication Engineering, YOP-2021',
      'UG College': 'RV College of Engineering, Bangalore',
      'Diploma/12th': 'Diploma in Electronics and Communication Engineering, YOP-2018',
      'Polytechnic College': 'East West Institute of Polytechnic, Bangalore'
    }
  ],
  Skills: [
    {
  ...
  'Languages Known': [ { List: 'English, Telugu, Tamil, Kannada and Hindi' } ],
  Certifications: [
    {
      '1': 'GUVI-JavaScript, valid from 2022',
      '2': 'NPTEL-Introduction to Internet of Things, valid from 2021',
  ...
  Projects: [
    {
      ...
      '5. Description': 'Designed a cost effective real time remote monitoring pulse oximetry system using ESP8266 and IoT.',
      '6. Duration': '3 months',
      '7. Title': 'Automatic Siren System for Institutions using 8051 Microcontroller and IoT',
      '8. Description': 'Designed an automatic siren system for institutions using 8051 microcontroller and IoT.',
      '9. Duration': '5 months'
    }
  ],
  Extracurricular: [
